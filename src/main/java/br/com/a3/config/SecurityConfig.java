    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/produtos/**", "/api/v1/movimentacoes/**")
                        .hasAnyRole("ADMIN", "SUPERUSER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/produtos/**", "/api/v1/movimentacoes/**")
                        .hasAnyRole("ADMIN", "SUPERUSER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/produtos/**", "/api/v1/movimentacoes/**")
                        .hasAnyRole("ADMIN", "SUPERUSER")
                        .anyRequest()
                        .authenticated())
