    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/health", "/api/v1/config").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/v1/config").hasRole("SUPERUSER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/usuarios/me/senha").authenticated()
                        .requestMatchers("/api/v1/usuarios/**").hasRole("SUPERUSER")
                        .requestMatchers("/api/v1/infra/**").hasRole("SUPERUSER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/relatorios/financeiro/usuarios").hasAnyRole("ADMIN", "SUPERUSER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/produtos/**").hasAnyRole("ADMIN", "SUPERUSER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/produtos/**").hasAnyRole("ADMIN", "SUPERUSER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/produtos/**").hasAnyRole("ADMIN", "SUPERUSER")
                        .requestMatchers(HttpMethod.POST, "/api/v1/movimentacoes/**", "/api/v1/clientes/**")
                        .hasAnyRole("USER", "ADMIN", "SUPERUSER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/movimentacoes/**", "/api/v1/clientes/**")
                        .hasAnyRole("USER", "ADMIN", "SUPERUSER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/movimentacoes/**", "/api/v1/clientes/**")
                        .hasAnyRole("USER", "ADMIN", "SUPERUSER")
                        .anyRequest()
                        .authenticated())
